  ...
  function Specie(name, data) {
    ...
    if (data.otherFormes) {
      ...
      if (gen >= 9 && !["toxtricity", "urshifu"].includes(this.id)) {
        ...
        if (this.otherFormes)
          this.otherFormes = __spreadArray(
            [],
            __read(new Set(this.otherFormes)),
            false
          );
      }
    }
...
try {
  for (
    var SPECIES_1 = __values(exports.SPECIES), SPECIES_1_1 = SPECIES_1.next();
    !SPECIES_1_1.done;
    SPECIES_1_1 = SPECIES_1.next()
  ) {
  ...
  try {
    if (SPECIES_1_1 && !SPECIES_1_1.done && (_a = SPECIES_1["return"]))
      _a.call(SPECIES_1);
  } finally {
